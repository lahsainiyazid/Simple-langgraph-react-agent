...
from langgraph.prebuilt import ToolNode,tools_condition #ToolNode->Create a tool node ,tools_condition->checks if llm asked for tool and executes it.  
...
builder.add_node("tools",ToolNode([multiply])) #allows us to create node that execute a tool :
